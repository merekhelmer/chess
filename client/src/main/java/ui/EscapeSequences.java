...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_LIGHT_SQUARE = SET_BG_COLOR + "180m"; // Light brown
    public static final String SET_BG_COLOR_DARK_SQUARE = SET_BG_COLOR + "94m";   // Dark brown
